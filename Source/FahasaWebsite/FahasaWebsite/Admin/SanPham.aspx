<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SanPham.aspx.cs" Inherits="FahasaWebsite.Admin.SanPham" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Sản phẩm</title>
        ...
        function printTable() {
            ...
            printWindow.document.write('td:nth-child(2), th:nth-child(2) { text-align: center !important; }');
            printWindow.document.write('th:nth-child(3), th:nth-child(3) { width: 500px !important; }');
            printWindow.document.write('td:nth-child(3), th:nth-child(3) { width: 500px !important; }');
            printWindow.document.write('th:nth-child(4), th:nth-child(4) { width: 120px; padding-right: 0px; text-align: center !important; }');
            printWindow.document.write('td:nth-child(4), th:nth-child(4) { width: 120px; padding-right: 10px !important; }');
            printWindow.document.write('th:nth-child(5), th:nth-child(5) { width: 200px; padding-right: 0px; text-align: center !important; }');
            printWindow.document.write('td:nth-child(5), th:nth-child(5) { width: 200px; padding-right: 10px !important; }');
            printWindow.document.write('</style>');

            printWindow.document.write('<style>');
            printWindow.document.write('@media print {');
            printWindow.document.write('  td:nth-child(6), th:nth-child(6),');
            printWindow.document.write('  td:nth-child(7), th:nth-child(7) { display: none; }');
            ...
            printWindow.document.write('<h2>DANH SÁCH SẢN PHẨM</h2>');
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h2 class="card-title mb-0" style="font-weight: bolder;">SẢN PHẨM</h2>
                            <div class="input-with-icon">
                                <div class="customize-input" style="position: relative; width: 300px;">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control custom-shadow custom-radius border-0 bg-white"
                                        placeholder="Nhập tên sản phẩm" AutoPostBack="false"></asp:TextBox>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="font-weight: bolder; width: 150px;">Mã sản phẩm</th>
                                        <th scope="col" style="font-weight: bolder; width: 450px;">Tên sản phẩm</th>
                                        <th scope="col" style="font-weight: bolder; width: 300px; text-align: right; padding-right: 50px;">Giá bán</th>
                                        <th scope="col" style="font-weight: bolder; width: 300px; text-align: right; padding-right: 50px;">Số lượng tồn kho</th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rptSanPham" runat="server" OnItemCommand="rptSanPham_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td scope="row" style="width: 30px; "><img src='<%# Eval("HinhSP") %>' style="width: 30px; height: 30px; " alt='<%# Eval("TenSP") %>'></td>
                                                <td scope="row" style="width: 150px; "><%# Eval("MaSP") %></td>
                                                <td scope="row" style="width: 450px; "><%# Eval("TenSP") %></td>
                                                <td scope="row" style="width: 300px; text-align: right; padding-right: 50px; "><%# String.Format("{0:#,##0}₫", Eval("GiaBan")) %></td>
                                                <td scope="row" style="width: 300px; text-align: right; padding-right: 50px; "><%# Eval("SoLuongTon") %></td>
