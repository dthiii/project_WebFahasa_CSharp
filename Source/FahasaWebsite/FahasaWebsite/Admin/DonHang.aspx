<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DonHang.aspx.cs" Inherits="FahasaWebsite.Admin.DonHang" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function printTable() {
            ...
            printWindow.document.write('td:nth-child(2) { text-align: center !important; }');
            printWindow.document.write('td:nth-child(3) { text-align: justify !important; }');
            printWindow.document.write('td:nth-child(4) { text-align: justify !important; }');
            ...
            printWindow.document.write('<h2>DANH SÁCH ĐƠN HÀNG</h2>');
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h2 class="card-title mb-0" style="font-weight: bolder;">ĐƠN HÀNG</h2>
                            <div class="input-with-icon">
                                <div class="customize-input" style="position: relative; width: 300px;">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control custom-shadow custom-radius border-0 bg-white"
                                        placeholder="Nhập mã đơn hàng" AutoPostBack="false"></asp:TextBox>
                        ...
                        <div class="table-responsive" style="margin-top: 50px;">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col" style="font-weight: bolder; width: 200px;">Mã đơn hàng</th>
                                        <th scope="col" style="font-weight: bolder; width: 250px;">Ngày đặt hàng</th>
                                        <th scope="col" style="font-weight: bolder; width: 350px;">Phương thức vận chuyển</th>
                                        <th scope="col" style="font-weight: bolder; width: 350px;">Phương thức thanh toán</th>
                                        <th scope="col" style="font-weight: bolder; width: 200px; text-align: right;">Tổng tiền</th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rptDonHang" runat="server" OnItemCommand="rptDonHang_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td scope="row" style="width: 200px;"><%# Eval("MaDH") %></td>
                                                <td scope="row" style="width: 250px;"><%# Convert.ToDateTime(Eval("NgayDatHang")).ToString("dd/MM/yyyy") %></td>
                                                <td scope="row" style="width: 350px;"><%# Eval("PTVanChuyen") %></td>
                                                <td scope="row" style="width: 350px;"><%# Eval("PTTT") %></td>
                                                <td scope="row" style="width: 200px; text-align: right;"><%# String.Format("{0:#,##0}₫", Eval("TongTien")) %></td>

                                                <td style="width: 10px;">
                                                    <asp:LinkButton ID="btnMore" runat="server"                                                        
                                                        CommandName="MoreItem"
                                                ...
                                                <td style="width: 10px;">
                                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="DeleteItem"
                                                        ...
                                                        OnClientClick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này không?');">
